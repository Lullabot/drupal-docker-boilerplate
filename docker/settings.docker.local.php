 ...
 */
$wodby['hosts'][] = $_SERVER['COMPOSE_PROJECT_NAME'] . '.docker.localhost';

$wodby['files_dir'] = '/var/www/html/files';
$wodby['site'] = 'default';
$wodby['hash_salt'] = hash('sha256', $wodby['hosts'][0]);
$wodby['sync_salt'] = '';
...
$config_directories['sync'] = $wodby['files_dir'] . '/config/sync' . $wodby['sync_salt'];
